...
public final class HudScriptEditorScreen extends Screen {
    ...
    private void applyScript() {
        ...
        if (minecraft.player != null) {
            minecraft.player.sendSystemMessage(Component.literal("The script has been added successfully."));
        }
    ...
    public void extractRenderState(GuiGraphicsExtractor context, int mouseX, int mouseY, float deltaTicks) {
        ...
        } else if (!manager.getLastInfo().isEmpty()) {
            context.text(font, manager.getLastInfo(), 16, height - 68, 0xFF70E1FF, true);
        }
    }
}
