...
public final class WidgetSettingsScreen extends Screen {
    ...
    protected void init() {
        ...
        doneButton = Button.builder(Component.literal("Done"), ignored -> onClose())
    ...
    public boolean mouseClicked(MouseButtonEvent click, boolean doubled) {
        // Action buttons must have priority when controls overlap in the settings footer area.
        if (doneButton != null && doneButton.mouseClicked(click, doubled)) {
            return true;
        }
